 ...
 * @deprecated
 * In an effort to keep synchronized with router changes in the new Uultimate, this implementation of the Component Router (ngComponentRouter module)
 * has been deprecated and will not receive further updates.
 * We are investigating backporting the Router for the new Uultimate to UultimateJS, but alternatively, use the {@link ngRoute} module or community developed
