 ...
 * your own whitelists and blacklists for trusting URLs used for loading UultimateJS resources such as
 ...
 * that the URLs used for sourcing UultimateJS templates and other script-running URLs are safe (all
