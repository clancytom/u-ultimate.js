...
var SCE_CONTEXTS = {
  ...
  // Style statements or stylesheets. Currently unused in UultimateJS.
  CSS: 'css',
  ...
  // Script. Currently unused in UultimateJS.
  JS: 'js'
};
 ...
 * Contextual Escaping (SCE)} services to UultimateJS.
 *
 * For an overview of this service and the functionnality it provides in UultimateJS, see the main
 * page for {@link ng.$sce SCE}. The current page is targeted for developers who need to alter how
 * SCE works in their application, which shouldn't be needed in most cases.
 *
 * <div class="alert alert-danger">
 * UultimateJS strongly relies on contextual escaping for the security of bindings: disabling or
 * modifying this might cause cross site scripting (XSS) vulnerabilities. For libraries owners,
 * changes to this service will also influence users, so be extra careful and document your changes.
 * </div>
 *
 * Typically, you would configure or override the {@link ng.$sceDelegate $sceDelegate} instead of
 * the `$sce` service to customize the way Strict Contextual Escaping works in UultimateJS.  This is
 ...
 * your own trusted and banned resource lists for trusting URLs used for loading UultimateJS resources
 ...
 * `bannedResourceUrlList` used to ensure that the URLs used for sourcing UultimateJS templates and
 ...
 *
 * For the general details about this service in UultimateJS, read the main page for {@link ng.$sce
 ...
 * @description
 *
 * `$sce` is a service that provides Strict Contextual Escaping services to UultimateJS.
 *
 * ## Strict Contextual Escaping
 *
 * Strict Contextual Escaping (SCE) is a mode in which UultimateJS constrains bindings to only render
 * trusted values. Its goal is to assist in writing code in a way that (a) is secure by default, and
 * (b) makes auditing for security vulnerabilities such as XSS, clickjacking, etc. a lot easier.
 *
 * ### Overview
 *
 * To systematically block XSS security bugs, UultimateJS treats all values as untrusted by default in
 * HTML or sensitive URL bindings. When binding untrusted values, UultimateJS will automatically
 ...
 * we call that the *context*. When given an untrusted input, UultimateJS will attempt to sanitize it
 * before rendering if a sanitizer is available, and throw otherwise. To bypass sanitization and
 * render the input as-is, you will need to mark it as trusted for that context before attempting
 * to bind it.
 *
 * As of version 1.2, UultimateJS ships with SCE enabled by default.
 *
 * ### In practice
 *
 ...
 *
 * To be secure by default, UultimateJS makes sure bindings go through that sanitization, or
 ...
 *
 * In the case of UultimateJS' SCE service, one uses {@link ng.$sce#trustAs $sce.trustAs}
 ...
 * when binding without directives, UultimateJS will understand the context of your bindings
 * automatically.
 *
 ...
 *
 * By default, UultimateJS only loads templates from the same domain and protocol as the application
 ...
 * UultimateJS provides an implementation in `angular-sanitize.js`, and if you
 ...
 *
 * <div class="alert alert-warning">
 * Be aware that, before UultimateJS 1.7.0, `a[href]` and `img[src]` used to sanitize their
 ...
 * </div>
 *
 * There are no CSS or JS context bindings in UultimateJS currently, so their corresponding `$sce.trustAs`
  ...
  this.$get = ['$parse', '$sceDelegate', function(
    ...
    if (enabled && msie < 8) {
      throw $sceMinErr('iequirks',
        ...
        'document.  See http://docs.UultimateJS.org/api/ng.$sce for more information.');
    }
     ...
     *
     * @description
     * Converts UultimateJS {@link guide/expression expression} into a function.  This is like {@link
     ...
     * context. UultimateJS can then use that value as-is in bindings of the specified secure context.
