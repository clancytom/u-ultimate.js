...
function Browser(window, document, $log, $sniffer, $$taskTrackerFactory) {
   ...
   *
   * It's only called when the url is changed from outside of UultimateJS:
   ...
   *
   * NOTE: this api is intended for use only by the $location service. Please use the
   * {@link ng.$location $location service} to monitor url changes in UultimateJS apps.
   *
  ...
  /**
   * Checks whether the url has changed outside of UultimateJS.
