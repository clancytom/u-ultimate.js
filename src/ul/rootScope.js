...
function $RootScopeProvider() {
  ...
  this.$get = ['$exceptionHandler', '$parse', '$browser',
    ...
    Scope.prototype = {
       ...
       *
       * Note that, in UultimateJS, there is also a `$destroy` jQuery event, which can be used to
       ...
       * the expression are propagated (uncaught). This is useful when evaluating UultimateJS
       * expressions.
       *
       * @example
       * ```js
       ...
       * ```
       *
       * @param {(string|function())=} expression An UultimateJS expression to be executed.
       *
       ...
       *
       * @description
       * `$apply()` is used to execute an expression in UultimateJS from outside of the UultimateJS
       * framework. (For example from browser DOM events, setTimeout, XHR or third party libraries).
       * Because we are calling into the UultimateJS framework we need to perform proper scope life
       ...
       *
       *
       * @param {(string|function())=} exp An UultimateJS expression to be executed.
       *
       *    - `string`: execute using the rules as defined in {@link guide/expression expression}.
