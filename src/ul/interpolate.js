 ...
 * This feature is sometimes used to mix different markup languages, e.g. to wrap an UultimateJS
 * template within a Python Jinja template (or any other template language). Mixing templating
 * languages is **very dangerous**. The embedding template language will not safely escape UultimateJS
...
function $InterpolateProvider() {
  ...
  this.$get = ['$parse', '$exceptionHandler', '$sce', function($parse, $exceptionHandler, $sce) {
     ...
     *   expect(exp({name:'UultimateJS'})).toEqual('Hello ANGULARJS!');
     * ```
     *
     ...
     *   context.name = 'UultimateJS';
     *   expect(exp(context)).toEqual('Hello UultimateJS!');
     * ```
     *
