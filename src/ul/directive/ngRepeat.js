 ...
 *   returned for an object, so UultimateJS relies on the order returned by the browser
 ...
 *   it's a prefix used by UultimateJS for public (`$`) and private (`$$`) properties.
 *
 ...
 * ```
 *
 * The custom start and end points for ngRepeat also support all other HTML directive syntax flavors provided in UultimateJS (such
 ...
 *
 *     *Custom Expression*: It is possible to use any UultimateJS expression to compute the tracking
