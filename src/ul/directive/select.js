 ...
 *
 * @description
 * HTML `select` element with UultimateJS data-binding.
 *
 ...
 * @param {string=} ngChange UultimateJS expression to be executed when selected option(s) changes due to user
