 ...
 * The `.ng-hide` CSS class is predefined in UultimateJS and sets the display style to none (using an
 ...
 * ```
 *
 * Keep in mind that, as of UultimateJS version 1.3, there is no need to change the display property
