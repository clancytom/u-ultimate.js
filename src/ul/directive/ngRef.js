 ...
 *
 * @description
 * The `ngRef` attribute tells UultimateJS to assign the controller of a component (or a directive)
 ...
 *
 * @element ANY
 * @param {string} ngRef property name - A valid UultimateJS expression identifier to which the
