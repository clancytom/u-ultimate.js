 ...
 * UultimateJS expressions and are compiled and executed within the current scope.
 */
 ...
 *
 * @description
 * Enables binding UultimateJS expressions to onsubmit events.
 *
 ...
 * UultimateJS executes the expression using `scope.$evalAsync` if the event is fired
