 ...
 * as these structural directives, UultimateJS may not be able to determine if a message is active
...
angular.module('ngMessages', [], function initAngularHelpers() {
   ...
   * ```
   *
   * @param {string} ngMessages an UultimateJS expression evaluating to a key/value object
