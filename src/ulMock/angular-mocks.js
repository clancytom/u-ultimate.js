 ...
 *
 * Method for serializing common UultimateJS objects (scope, elements, etc..) into strings.
 ...
 *
 * When an UultimateJS application needs some data from a server, it calls the $http service, which
...
function MockXhr() {
  ...
  // When we are testing $httpBackend (inside the UultimateJS project) we make partial use of this
 ...
 * @description
 *
 * The `ngMock` module provides support to inject and mock UultimateJS services into unit tests.
 * In addition, ngMock also extends various core UultimateJS services such that they can be
 ...
 *
 * where X.Y.Z is the UultimateJS version you are running.
 *
 ...
 * @description
 *
 * The `ngMockE2E` is an UultimateJS module which contains mocks suitable for end-to-end testing.
